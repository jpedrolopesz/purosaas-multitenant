        ...
        <div class="flex items-center justify-between h-16 -mb-px">
            ...
            <div class="logo ml-14">
                <a href="{{route('tenant.dashboard.dashboard')}}">
                    @if(tenant()->logo)
                        <img class="mx-auto h-8 w-auto ml-2" src="/uploads/avatars/{{tenant()->logo}}"  alt="logo" />
                    @else
                    @endif
                </a>
            </div>
            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="relative inline-flex" x-data="{ open: false }">
                    <button
                        ...
                        :aria-expanded="open"
                    >
                        <img class="w-8 h-8 rounded-full" src="/uploads/avatars/{{Auth::user()->avatar}}" width="32" height="32" alt="User" />
