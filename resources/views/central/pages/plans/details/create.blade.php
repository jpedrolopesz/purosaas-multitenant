    ...
    <nav class="flex p-3" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
                <div class="flex items-center">
                    <svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                    <a href="{{route('central.pages.plans.details.index', $plans->id)}}" class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">
                        {{$plans->name}}
                    </a>
                </div>
            </li>
    ...
    <div class="flex flex-col w-full bg-white border rounded-lg md:w-5/5 border-gray-150">
        ...
        <div class="flex flex-wrap items-center justify-between border-b border-gray-200 sm:flex-no-wrap">
            <div class="flex-1 min-w-0 px-4 py-5 sm:px-6 ">
                ...
                <p class="mt-1 max-w-2xl text-sm text-gray-500">Create plan details for your future customers</p>
            </div>


        </div>

        <form action="{{route('central.details.store', $plans->id)}}" method="POST">
            @csrf
            <div class="mt-5 md:mt-0 md:col-span-2">
                <div class="shadow overflow-hidden sm:rounded-md">
                    ...
                    <div class="px-4 py-3  bg-gray-50 text-right sm:px-6">
                        <a href="{{route('central.pages.plans.details.index', $plans->id)}}" class="relative inline-flex items-center px-4 py-2 text-sm font-medium text-black bg-white border border-gray-300 leading-5 rounded-md hover:text-gray-500 focus:outline-none focus:ring-blue focus:border-blue-300  ">
                            « Back
                        </a>
