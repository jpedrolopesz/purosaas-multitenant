...
@section('content')
    ...
    <div class="flex flex-col w-full bg-white border rounded-lg md:w-5/5 border-gray-150">
        ...
        <form action="{{route('central.plans.update' , $plan->id)}}" method="POST">
            @csrf
            @method('PUT')
                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-4">
                                ...
                                <input value="{{$plan->name}}" type="text" name="name" autocomplete="name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">

                            </div>

                            <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                <label for="price" class="block text-sm font-medium text-gray-700">Price</label>
                                <input value="{{$plan->price}}" type="number" name="price" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            </div>
                            ...
                            <div class="col-span-12 sm:col-span-13">
                                ...
                                <div class="mt-1">
                                    <textarea placeholder="{{$plan->description}}" name="description" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" ></textarea>
                                </div>
                            ...
                            <div class="col-span-6 sm:col-span-4">
                                ...
                                <input value="{{$plan->stripe_id}}" type="text" name="stripe_id" id="stripe_id"  class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            </div>
